            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <ol class="breadcrumb pull-right">
                        <li class="breadcrumb-item"><a href="i"><i data-feather="home"></i></a></li>
                            ...
                            <div class="tab-pane fade active show" id="account" role="tabpanel" aria-labelledby="account-tab">
                                <form class="needs-validation user-add"  method="post" action="">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control col-xl-8 col-md-7" name="designation" id="validationCustom1" type="text">
                                    </div>
                                    <div class="form-group row">
                                        <label for="validationCustom2" class="col-xl-3 col-md-4"><span>*</span> Email</label>
                                        <input class="form-control col-xl-8 col-md-7" name="email" id="validationCustom2" type="text" required>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control col-xl-8 col-md-7" name="pin" id="validationCustom5" type="number" minlength="6" required>
                                    </div>
