                ...
                <div class="row">
                    <div class="col-md-5 p-0 card-left">
                     ...
                     <div class="single-item">
                        <div>
                            <div>
                                <h3>Welcome to <?=$info['shop_name'];?></h3>
                                <p>Developed by TechdynoBD<br>We are all you need for your digital buisness platform.</p>
                            </div>
                        </div>
                        <div>
                            <div>
                                ...
                                <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                                    <form class="form-horizontal auth-form" method="post" action="">
                                        <div class="form-group">
                                            <input required name="email" type="email" class="form-control" placeholder="Username" id="exampleInputEmail1" required>
                                        </div>
                                        <div class="form-group">
                                            <input required name="password" type="password" class="form-control" placeholder="Password *">
                                        </div>
                                        <div class="form-group">
                                            <input required name="pin" type="number" class="form-control" placeholder="Pin * ">
                                        </div>
                                        <div class="form-terms">
                                            <div class="custom-control custom-checkbox mr-sm-2">
                                                <input type="checkbox" class="custom-control-input" name="rememberme" id="customControlAutosizing">
...
<!-- Mirrored from themes.pixelstrap.com/multikart/back-end/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Nov 2020 07:33:47 GMT -->
</html>
