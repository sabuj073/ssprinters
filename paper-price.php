...
if(isset($_GET['del'])){
    $check = deletepaperdetails($_GET['del']);
    if($check){
...
if(isset($_POST['insert'])){
    $check = insert_paper_details($_POST);
    if($check){
        echo "<script> window.onload = function() {
          update_msg();
      }; </script>";
...
if(isset($_POST['update'])){
    $check = update_paper_details($_POST);
    if($check){
        echo "<script> window.onload = function() {
          update_msg();
      }; </script>";
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Cutting Details</h5>
                    </div>
                    <div class="card-body">
                        <div class="btn-popup pull-right">
                            <button type="button" class="btn btn-secondary" data-toggle="modal" data-original-title="test" data-target="#exampleModal">Add Paper Prices</button>

                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title f-w-600" id="exampleModalLabel">Add Paper Price</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form">
                                                    <div class="form-group">
                                                        <label for="validationCustom01" class="mb-1">Paper Type/Name :</label>
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <label for="validationCustom02" class="mb-1">Paper Quantity in a rim :</label>
                                                        <input class="form-control" id="validationCustom02" name="qty" type="number" required>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title f-w-600" id="exampleModalLabel">Update Paper Price</h5>
                                            <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                        </div>
                                        <form class="needs-validation" method="post" action="">
                                            <div class="modal-body">
...
<script type="text/javascript">
    ...
    function getid(id,name,qty,price){
        $("#id").val(id);
